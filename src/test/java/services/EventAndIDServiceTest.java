...
public class EventAndIDServiceTest {
    ...
    /** We attempt to retrieve an existing event by its ID and ensure that we don't get an error
    ...
    /** We attempt to retrieve an event with a nonexistent ID and ensure that we get a warning
    ...
    /** We attempt to retrieve an event that is associated with a different user and ensure that
