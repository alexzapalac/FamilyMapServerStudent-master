...
public class RegisterServiceTest {
    ...
    public void registerLogsUserIn() {
        ...
        assertNotEquals(generatedAuthToken, result.getAuthToken());        //TODO:Issue with this line
    ...
    public void registerFailing() {
        try {
            assertEquals("[SQLITE_CONSTRAINT_PRIMARYKEY]  A PRIMARY KEY constraint failed (UNIQUE constraint failed: Users.username)", new RegisterService().register(request).getMessage());
        } catch (DatabaseException e) {
            throw new RuntimeException(e);
        }
    }
