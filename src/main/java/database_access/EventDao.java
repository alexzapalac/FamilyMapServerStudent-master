...
public class EventDao extends DAO {
    ...
    String getInsertStmt() {
        return "INSERT INTO Events (EventID, associatedUsername, PersonID, Latitude, Longitude, " +
    ...
    Object buildObjectFromResultString(ResultSet rs) throws SQLException {
        return new Event(rs.getString("EventID"), rs.getString("associatedUsername"),
                rs.getString("PersonID"), (double) rs.getFloat("Latitude"), (double) rs.getFloat("Longitude"),
